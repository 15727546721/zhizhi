          ...
          <el-row :gutter="24">
            ...
            <el-col :span="10">
              <el-form-item label="网站地址" prop="webUrl">
                <el-input v-model="formData.webUrl" style="width: 400px" />
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row :gutter="24">
            <el-col :span="10">
              <el-form-item label="关键字" prop="newPwd2">
                <el-input v-model="formData.keyword" style="width: 400px" />
              </el-form-item>
            </el-col>
            <el-col :span="10">
              <el-form-item label="描述" prop="newPwd1">
                <el-input v-model="formData.summary" style="width: 400px" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="24">
            <el-col :span="10">
              <el-form-item label="备案号" prop="newPwd2">
                <el-input v-model="formData.recordNum" style="width: 400px" />
              </el-form-item>
            </el-col>
            <el-col :span="10">
          ...
          <el-row :gutter="24">
            <el-col :span="10">
              <el-form-item label="作者" prop="newPwd2">
                <el-input v-model="formData.author" style="width: 400px" />
              </el-form-item>
            </el-col>
            <el-col :span="10">
              <el-form-item label="作者简介" prop="newPwd2">
                <el-input v-model="formData.authorInfo" style="width: 400px" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="24">
        ...
        >
          <el-checkbox-group v-model="showList">
            <el-form-item label="邮箱" prop="email">
              <el-input v-model="formData.email" style="width: 400px" />
              <el-checkbox
                value="1"
                label="在首页显示"
                style="margin-left: 10px"
            ...
            <el-form-item label="QQ号" prop="qqNumber">
              <el-input v-model="formData.qqNumber" style="width: 400px" />
              <el-checkbox
                value="2"
                label="在首页显示"
                style="margin-left: 10px"
            ...
            <el-form-item label="QQ群" prop="qqNumber">
              <el-input v-model="formData.qqGroup" style="width: 400px" />
              <el-checkbox
                value="6"
                label="在首页显示"
                style="margin-left: 10px"
            ...
            <el-form-item label="github" prop="github">
              <el-input v-model="formData.github" style="width: 400px" />
              <el-checkbox
                value="3"
                label="在首页显示"
                style="margin-left: 10px"
            ...
            <el-form-item label="Gitee" prop="gitee">
              <el-input v-model="formData.gitee" style="width: 400px" />
              <el-checkbox
                value="4"
                label="在首页显示"
                style="margin-left: 10px"
            ...
            <el-form-item label="微信" prop="wechat">
              <el-input v-model="formData.wechat" style="width: 400px" />
              <el-checkbox
                value="5"
                label="在首页显示"
                style="margin-left: 10px"
