...
public interface FavoriteFolderMapper {
     ...
     * 插入收藏夹
     */
    @Insert("INSERT INTO favorite_folder (user_id, name, description, is_default, is_public, content_count, sort, create_time, update_time) " +
            "VALUES (#{userId}, #{name}, #{description}, #{isDefault}, #{isPublic}, #{contentCount}, #{sort}, #{createTime}, #{updateTime})")
