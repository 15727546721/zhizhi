...
public class PostItemVO {
    ...
    @Schema(description = "帖子标题", example = "学习Java")
    private String title;

    @Schema(description = "帖子摘要/简介", example = "学习Java的基础内容...")
    private String description;

    @Schema(description = "帖子内容，具体内容", example = "学习Java的详细内容...")
    private String content;

    @Schema(description = "封面图片URL", example = "https://example.com/cover.jpg")
    private String coverUrl;

    @Schema(description = "帖子状态", example = "1", allowableValues = {"0", "1", "2"})
    ...
    @Schema(description = "用户类型，1-普通用户，2-系统账号，3-管理员", example = "1")
    private Integer userType;

    // ========== 互动信息 ==========

    @Schema(description = "阅读数", example = "1000")
    ...
    @Schema(description = "标签名称列表", example = "[\"Java\", \"编程\"]")
