...
public class UserSettingsVO {
    ...
    @Schema(description = "私信设置")
    private MessageSettingsVO messageSettings;
    ...
    public static class PrivacySettingsVO {
        ...
        @Schema(description = "个人资料可见性设置：1-公开，2-好友可见，3-仅自己可见", example = "1")
    ...
    public static class NotificationSettingsVO {
        ...
        @Schema(description = "消息提醒声音", example = "false")
    ...
    @AllArgsConstructor
    @Schema(description = "私信设置")
    public static class MessageSettingsVO {

        @Schema(description = "允许陌生人私信", example = "true")
