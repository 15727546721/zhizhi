package cn.xu.api.web.controller.topic;

import cn.xu.api.web.model.dto.common.ResponseEntity;
import cn.xu.api.web.model.dto.topic.TopicDTO;
...
public class TopicController {
    ...
    public ResponseEntity<List<TopicDTO>> getTopicsPage(@RequestParam(value = "pageNum", required = true) int pageNum,
