...
import cn.xu.infrastructure.common.utils.JsonUtils;
...
public class ApiOperationLogAspect {
    ...
    @Pointcut("@annotation(cn.xu.infrastructure.common.annotation.ApiOperationLog)")
    ...
    private String toJsonStr(Object object) {
        ...
        try {
            ...
            log.warn("无法将参数转化为 JSON 字符串: {}", object, e);
