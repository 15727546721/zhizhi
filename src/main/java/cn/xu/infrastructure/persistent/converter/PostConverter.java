...
public class PostConverter {
    ...
    public static Post toDataObject(PostEntity postEntity) {
        ...
        return Post.builder()
                ...
                .favoriteCount(postEntity.getFavoriteCount() != null ? postEntity.getFavoriteCount().longValue() : 0L)
                .shareCount(postEntity.getShareCount() != null ? postEntity.getShareCount().longValue() : 0L)
    ...
    public static PostEntity toDomainEntity(Post post) {
        ...
        return PostEntity.builder()
                ...
                .favoriteCount(post.getFavoriteCount() != null ? post.getFavoriteCount().longValue() : 0L)
                .shareCount(post.getShareCount() != null ? post.getShareCount().longValue() : 0L)
