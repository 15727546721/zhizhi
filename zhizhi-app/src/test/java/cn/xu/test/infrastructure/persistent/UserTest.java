...
import cn.xu.infrastructure.persistent.dao.IUser;
...
public class UserTest {
    ...
    @Resource
    private IUser iUserser;

    @Test
    public void test() {
        iUserser.insert(new UserPO(10001L, "小傅哥", "fustack", "123456", "13800138000", "fustack@qq.com", "1", "1", new Date(), new Date()));
    }
